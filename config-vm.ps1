...
Get-Get-DscLocalConfigurationManager
...
Set-Content -Path .\remote.ps1 -Value $remoteCommand
Invoke-AzVMRunCommand -ResourceGroupName $rgname -VMName $vmname -ScriptPath .\remote.ps1 -CommandId "RunPowerShellScript"
Remove-Item .\remote.ps1
